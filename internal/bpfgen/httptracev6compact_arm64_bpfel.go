...
// LoadHttpTraceV6Compact returns the embedded CollectionSpec for HttpTraceV6Compact.
func LoadHttpTraceV6Compact() (*ebpf.CollectionSpec, error) {
	reader := bytes.NewReader(_HttpTraceV6CompactBytes)
	spec, err := ebpf.LoadCollectionSpecFromReader(reader)
	if err != nil {
		return nil, fmt.Errorf("can't load HttpTraceV6Compact: %w", err)
	}

	return spec, err
}

// LoadHttpTraceV6CompactObjects loads HttpTraceV6Compact and converts it into a struct.
//
// The following types are suitable as obj argument:
//
//	*HttpTraceV6CompactObjects
//	*HttpTraceV6CompactPrograms
//	*HttpTraceV6CompactMaps
//
// See ebpf.CollectionSpec.LoadAndAssign documentation for details.
func LoadHttpTraceV6CompactObjects(obj interface{}, opts *ebpf.CollectionOptions) error {
...
// HttpTraceV6CompactSpecs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceV6CompactSpecs struct {
	HttpTraceV6CompactProgramSpecs
	HttpTraceV6CompactMapSpecs
	HttpTraceV6CompactVariableSpecs
}

// HttpTraceV6CompactProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceV6CompactProgramSpecs struct {
...
// HttpTraceV6CompactMapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceV6CompactMapSpecs struct {
...
// HttpTraceV6CompactVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceV6CompactVariableSpecs struct {
}

// HttpTraceV6CompactObjects contains all objects after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceV6CompactObjects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceV6CompactObjects struct {
	HttpTraceV6CompactPrograms
	HttpTraceV6CompactMaps
	HttpTraceV6CompactVariables
}

func (o *HttpTraceV6CompactObjects) Close() error {
	return _HttpTraceV6CompactClose(
		&o.HttpTraceV6CompactPrograms,
		&o.HttpTraceV6CompactMaps,
	)
}

// HttpTraceV6CompactMaps contains all maps after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceV6CompactObjects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceV6CompactMaps struct {
...
func (m *HttpTraceV6CompactMaps) Close() error {
	return _HttpTraceV6CompactClose(
		m.ConnectArgsMap,
		m.DebugSnapshotMap,
		m.Events,
...
// HttpTraceV6CompactVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceV6CompactObjects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceV6CompactVariables struct {
}

// HttpTraceV6CompactPrograms contains all programs after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceV6CompactObjects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceV6CompactPrograms struct {
...
func (p *HttpTraceV6CompactPrograms) Close() error {
	return _HttpTraceV6CompactClose(
		p.KprobeSockRecvmsg,
		p.KprobeSockSendmsg,
		p.KprobeTcpClose,
...
func _HttpTraceV6CompactClose(closers ...io.Closer) error {
...
//
//go:embed httptracev6compact_arm64_bpfel.o
var _HttpTraceV6CompactBytes []byte
