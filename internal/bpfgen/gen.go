...
//go:generate env GOPROXY=off GOSUMDB=off go run github.com/cilium/ebpf/cmd/bpf2go -tags linux -target amd64 -cc clang -strip llvm-strip -no-global-types HttpTraceTCPOnly ../../bpf/http_trace.bpf.c -- -O2 -Wall -Werror -DTCP_ONLY_LEAN=1 -I../../bpf/include -I/usr/include/x86_64-linux-gnu
//go:generate ../../scripts/strip-bpf.sh httptracetcponly_x86_bpfel.o
//go:generate env GOPROXY=off GOSUMDB=off go run github.com/cilium/ebpf/cmd/bpf2go -tags linux -target arm64 -cc clang -strip llvm-strip -no-global-types HttpTraceTCPOnly ../../bpf/http_trace.bpf.c -- -O2 -Wall -Werror -DTCP_ONLY_LEAN=1 -I../../bpf/include -I/usr/aarch64-linux-gnu/include
//go:generate ../../scripts/strip-bpf.sh httptracetcponly_arm64_bpfel.o
//go:generate env GOPROXY=off GOSUMDB=off go run github.com/cilium/ebpf/cmd/bpf2go -tags linux -target amd64 -cc clang -strip llvm-strip -no-global-types HttpTraceTCPOnlyCompact ../../bpf/http_trace.bpf.c -- -O1 -Wall -Werror -DCOMPACT_VERIFIER=1 -DTCP_ONLY_LEAN=1 -I../../bpf/include -I/usr/include/x86_64-linux-gnu
//go:generate ../../scripts/strip-bpf.sh httptracetcponlycompact_x86_bpfel.o
//go:generate env GOPROXY=off GOSUMDB=off go run github.com/cilium/ebpf/cmd/bpf2go -tags linux -target arm64 -cc clang -strip llvm-strip -no-global-types HttpTraceTCPOnlyCompact ../../bpf/http_trace.bpf.c -- -O1 -Wall -Werror -DCOMPACT_VERIFIER=1 -DTCP_ONLY_LEAN=1 -I../../bpf/include -I/usr/aarch64-linux-gnu/include
//go:generate ../../scripts/strip-bpf.sh httptracetcponlycompact_arm64_bpfel.o
...
//go:generate env GOPROXY=off GOSUMDB=off go run github.com/cilium/ebpf/cmd/bpf2go -tags linux -target amd64 -cc clang -strip llvm-strip -no-global-types HttpTraceTCPOnlyV6 ../../bpf/http_trace.bpf.c -- -O2 -Wall -Werror -DIOV_ITER_LAYOUT_V6=1 -DTCP_ONLY_LEAN=1 -I../../bpf/include -I/usr/include/x86_64-linux-gnu
//go:generate ../../scripts/strip-bpf.sh httptracetcponlyv6_x86_bpfel.o
//go:generate env GOPROXY=off GOSUMDB=off go run github.com/cilium/ebpf/cmd/bpf2go -tags linux -target arm64 -cc clang -strip llvm-strip -no-global-types HttpTraceTCPOnlyV6 ../../bpf/http_trace.bpf.c -- -O2 -Wall -Werror -DIOV_ITER_LAYOUT_V6=1 -DTCP_ONLY_LEAN=1 -I../../bpf/include -I/usr/aarch64-linux-gnu/include
//go:generate ../../scripts/strip-bpf.sh httptracetcponlyv6_arm64_bpfel.o
...
//go:generate env GOPROXY=off GOSUMDB=off go run github.com/cilium/ebpf/cmd/bpf2go -tags linux -target amd64 -cc clang -strip llvm-strip -no-global-types HttpTraceTCPOnlyV66 ../../bpf/http_trace.bpf.c -- -O2 -Wall -Werror -DIOV_ITER_LAYOUT_V66=1 -DTCP_ONLY_LEAN=1 -I../../bpf/include -I/usr/include/x86_64-linux-gnu
//go:generate ../../scripts/strip-bpf.sh httptracetcponlyv66_x86_bpfel.o
//go:generate env GOPROXY=off GOSUMDB=off go run github.com/cilium/ebpf/cmd/bpf2go -tags linux -target arm64 -cc clang -strip llvm-strip -no-global-types HttpTraceTCPOnlyV66 ../../bpf/http_trace.bpf.c -- -O2 -Wall -Werror -DIOV_ITER_LAYOUT_V66=1 -DTCP_ONLY_LEAN=1 -I../../bpf/include -I/usr/aarch64-linux-gnu/include
//go:generate ../../scripts/strip-bpf.sh httptracetcponlyv66_arm64_bpfel.o
...
//go:generate env GOPROXY=off GOSUMDB=off go run github.com/cilium/ebpf/cmd/bpf2go -tags linux -target amd64 -cc clang -strip llvm-strip -no-global-types HttpTraceTCPOnlyV6Compact ../../bpf/http_trace.bpf.c -- -O1 -Wall -Werror -DCOMPACT_VERIFIER=1 -DIOV_ITER_LAYOUT_V6=1 -DTCP_ONLY_LEAN=1 -I../../bpf/include -I/usr/include/x86_64-linux-gnu
//go:generate ../../scripts/strip-bpf.sh httptracetcponlyv6compact_x86_bpfel.o
//go:generate env GOPROXY=off GOSUMDB=off go run github.com/cilium/ebpf/cmd/bpf2go -tags linux -target arm64 -cc clang -strip llvm-strip -no-global-types HttpTraceTCPOnlyV6Compact ../../bpf/http_trace.bpf.c -- -O1 -Wall -Werror -DCOMPACT_VERIFIER=1 -DIOV_ITER_LAYOUT_V6=1 -DTCP_ONLY_LEAN=1 -I../../bpf/include -I/usr/aarch64-linux-gnu/include
//go:generate ../../scripts/strip-bpf.sh httptracetcponlyv6compact_arm64_bpfel.o
...
//go:generate env GOPROXY=off GOSUMDB=off go run github.com/cilium/ebpf/cmd/bpf2go -tags linux -target amd64 -cc clang -strip llvm-strip -no-global-types HttpTraceTCPOnlyV66Compact ../../bpf/http_trace.bpf.c -- -O1 -Wall -Werror -DCOMPACT_VERIFIER=1 -DIOV_ITER_LAYOUT_V66=1 -DTCP_ONLY_LEAN=1 -I../../bpf/include -I/usr/include/x86_64-linux-gnu
//go:generate ../../scripts/strip-bpf.sh httptracetcponlyv66compact_x86_bpfel.o
//go:generate env GOPROXY=off GOSUMDB=off go run github.com/cilium/ebpf/cmd/bpf2go -tags linux -target arm64 -cc clang -strip llvm-strip -no-global-types HttpTraceTCPOnlyV66Compact ../../bpf/http_trace.bpf.c -- -O1 -Wall -Werror -DCOMPACT_VERIFIER=1 -DIOV_ITER_LAYOUT_V66=1 -DTCP_ONLY_LEAN=1 -I../../bpf/include -I/usr/aarch64-linux-gnu/include
//go:generate ../../scripts/strip-bpf.sh httptracetcponlyv66compact_arm64_bpfel.o
