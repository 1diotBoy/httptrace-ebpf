...
// LoadHttpTraceTCPOnlyCompact returns the embedded CollectionSpec for HttpTraceTCPOnlyCompact.
func LoadHttpTraceTCPOnlyCompact() (*ebpf.CollectionSpec, error) {
	reader := bytes.NewReader(_HttpTraceTCPOnlyCompactBytes)
	spec, err := ebpf.LoadCollectionSpecFromReader(reader)
	if err != nil {
		return nil, fmt.Errorf("can't load HttpTraceTCPOnlyCompact: %w", err)
	}

	return spec, err
}

// LoadHttpTraceTCPOnlyCompactObjects loads HttpTraceTCPOnlyCompact and converts it into a struct.
//
// The following types are suitable as obj argument:
//
//	*HttpTraceTCPOnlyCompactObjects
//	*HttpTraceTCPOnlyCompactPrograms
//	*HttpTraceTCPOnlyCompactMaps
//
// See ebpf.CollectionSpec.LoadAndAssign documentation for details.
func LoadHttpTraceTCPOnlyCompactObjects(obj interface{}, opts *ebpf.CollectionOptions) error {
...
// HttpTraceTCPOnlyCompactSpecs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceTCPOnlyCompactSpecs struct {
	HttpTraceTCPOnlyCompactProgramSpecs
	HttpTraceTCPOnlyCompactMapSpecs
	HttpTraceTCPOnlyCompactVariableSpecs
}

// HttpTraceTCPOnlyCompactProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceTCPOnlyCompactProgramSpecs struct {
...
// HttpTraceTCPOnlyCompactMapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceTCPOnlyCompactMapSpecs struct {
...
// HttpTraceTCPOnlyCompactVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceTCPOnlyCompactVariableSpecs struct {
}

// HttpTraceTCPOnlyCompactObjects contains all objects after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceTCPOnlyCompactObjects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceTCPOnlyCompactObjects struct {
	HttpTraceTCPOnlyCompactPrograms
	HttpTraceTCPOnlyCompactMaps
	HttpTraceTCPOnlyCompactVariables
}

func (o *HttpTraceTCPOnlyCompactObjects) Close() error {
	return _HttpTraceTCPOnlyCompactClose(
		&o.HttpTraceTCPOnlyCompactPrograms,
		&o.HttpTraceTCPOnlyCompactMaps,
	)
}

// HttpTraceTCPOnlyCompactMaps contains all maps after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceTCPOnlyCompactObjects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceTCPOnlyCompactMaps struct {
...
func (m *HttpTraceTCPOnlyCompactMaps) Close() error {
	return _HttpTraceTCPOnlyCompactClose(
		m.ConnectArgsMap,
		m.DebugSnapshotMap,
		m.Events,
...
// HttpTraceTCPOnlyCompactVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceTCPOnlyCompactObjects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceTCPOnlyCompactVariables struct {
}

// HttpTraceTCPOnlyCompactPrograms contains all programs after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceTCPOnlyCompactObjects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceTCPOnlyCompactPrograms struct {
...
func (p *HttpTraceTCPOnlyCompactPrograms) Close() error {
	return _HttpTraceTCPOnlyCompactClose(
		p.KprobeSockRecvmsg,
		p.KprobeSockSendmsg,
		p.KprobeTcpClose,
...
func _HttpTraceTCPOnlyCompactClose(closers ...io.Closer) error {
...
//
//go:embed httptracetcponlycompact_arm64_bpfel.o
var _HttpTraceTCPOnlyCompactBytes []byte
