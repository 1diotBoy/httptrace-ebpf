...
// LoadHttpTraceTCPOnlyV66Compact returns the embedded CollectionSpec for HttpTraceTCPOnlyV66Compact.
func LoadHttpTraceTCPOnlyV66Compact() (*ebpf.CollectionSpec, error) {
	reader := bytes.NewReader(_HttpTraceTCPOnlyV66CompactBytes)
	spec, err := ebpf.LoadCollectionSpecFromReader(reader)
	if err != nil {
		return nil, fmt.Errorf("can't load HttpTraceTCPOnlyV66Compact: %w", err)
	}

	return spec, err
}

// LoadHttpTraceTCPOnlyV66CompactObjects loads HttpTraceTCPOnlyV66Compact and converts it into a struct.
//
// The following types are suitable as obj argument:
//
//	*HttpTraceTCPOnlyV66CompactObjects
//	*HttpTraceTCPOnlyV66CompactPrograms
//	*HttpTraceTCPOnlyV66CompactMaps
//
// See ebpf.CollectionSpec.LoadAndAssign documentation for details.
func LoadHttpTraceTCPOnlyV66CompactObjects(obj interface{}, opts *ebpf.CollectionOptions) error {
...
// HttpTraceTCPOnlyV66CompactSpecs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceTCPOnlyV66CompactSpecs struct {
	HttpTraceTCPOnlyV66CompactProgramSpecs
	HttpTraceTCPOnlyV66CompactMapSpecs
	HttpTraceTCPOnlyV66CompactVariableSpecs
}

// HttpTraceTCPOnlyV66CompactProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceTCPOnlyV66CompactProgramSpecs struct {
...
// HttpTraceTCPOnlyV66CompactMapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceTCPOnlyV66CompactMapSpecs struct {
...
// HttpTraceTCPOnlyV66CompactVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceTCPOnlyV66CompactVariableSpecs struct {
}

// HttpTraceTCPOnlyV66CompactObjects contains all objects after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceTCPOnlyV66CompactObjects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceTCPOnlyV66CompactObjects struct {
	HttpTraceTCPOnlyV66CompactPrograms
	HttpTraceTCPOnlyV66CompactMaps
	HttpTraceTCPOnlyV66CompactVariables
}

func (o *HttpTraceTCPOnlyV66CompactObjects) Close() error {
	return _HttpTraceTCPOnlyV66CompactClose(
		&o.HttpTraceTCPOnlyV66CompactPrograms,
		&o.HttpTraceTCPOnlyV66CompactMaps,
	)
}

// HttpTraceTCPOnlyV66CompactMaps contains all maps after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceTCPOnlyV66CompactObjects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceTCPOnlyV66CompactMaps struct {
...
func (m *HttpTraceTCPOnlyV66CompactMaps) Close() error {
	return _HttpTraceTCPOnlyV66CompactClose(
		m.ConnectArgsMap,
		m.DebugSnapshotMap,
		m.Events,
...
// HttpTraceTCPOnlyV66CompactVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceTCPOnlyV66CompactObjects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceTCPOnlyV66CompactVariables struct {
}

// HttpTraceTCPOnlyV66CompactPrograms contains all programs after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceTCPOnlyV66CompactObjects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceTCPOnlyV66CompactPrograms struct {
...
func (p *HttpTraceTCPOnlyV66CompactPrograms) Close() error {
	return _HttpTraceTCPOnlyV66CompactClose(
		p.KprobeSockRecvmsg,
		p.KprobeSockSendmsg,
		p.KprobeTcpClose,
...
func _HttpTraceTCPOnlyV66CompactClose(closers ...io.Closer) error {
...
//
//go:embed httptracetcponlyv66compact_arm64_bpfel.o
var _HttpTraceTCPOnlyV66CompactBytes []byte
