...
// LoadHttpTraceTCPOnlyV6 returns the embedded CollectionSpec for HttpTraceTCPOnlyV6.
func LoadHttpTraceTCPOnlyV6() (*ebpf.CollectionSpec, error) {
	reader := bytes.NewReader(_HttpTraceTCPOnlyV6Bytes)
	spec, err := ebpf.LoadCollectionSpecFromReader(reader)
	if err != nil {
		return nil, fmt.Errorf("can't load HttpTraceTCPOnlyV6: %w", err)
	}

	return spec, err
}

// LoadHttpTraceTCPOnlyV6Objects loads HttpTraceTCPOnlyV6 and converts it into a struct.
//
// The following types are suitable as obj argument:
//
//	*HttpTraceTCPOnlyV6Objects
//	*HttpTraceTCPOnlyV6Programs
//	*HttpTraceTCPOnlyV6Maps
//
// See ebpf.CollectionSpec.LoadAndAssign documentation for details.
func LoadHttpTraceTCPOnlyV6Objects(obj interface{}, opts *ebpf.CollectionOptions) error {
...
// HttpTraceTCPOnlyV6Specs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceTCPOnlyV6Specs struct {
	HttpTraceTCPOnlyV6ProgramSpecs
	HttpTraceTCPOnlyV6MapSpecs
	HttpTraceTCPOnlyV6VariableSpecs
}

// HttpTraceTCPOnlyV6ProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceTCPOnlyV6ProgramSpecs struct {
...
// HttpTraceTCPOnlyV6MapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceTCPOnlyV6MapSpecs struct {
...
// HttpTraceTCPOnlyV6VariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type HttpTraceTCPOnlyV6VariableSpecs struct {
}

// HttpTraceTCPOnlyV6Objects contains all objects after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceTCPOnlyV6Objects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceTCPOnlyV6Objects struct {
	HttpTraceTCPOnlyV6Programs
	HttpTraceTCPOnlyV6Maps
	HttpTraceTCPOnlyV6Variables
}

func (o *HttpTraceTCPOnlyV6Objects) Close() error {
	return _HttpTraceTCPOnlyV6Close(
		&o.HttpTraceTCPOnlyV6Programs,
		&o.HttpTraceTCPOnlyV6Maps,
	)
}

// HttpTraceTCPOnlyV6Maps contains all maps after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceTCPOnlyV6Objects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceTCPOnlyV6Maps struct {
...
func (m *HttpTraceTCPOnlyV6Maps) Close() error {
	return _HttpTraceTCPOnlyV6Close(
		m.ConnectArgsMap,
		m.DebugSnapshotMap,
		m.Events,
...
// HttpTraceTCPOnlyV6Variables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceTCPOnlyV6Objects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceTCPOnlyV6Variables struct {
}

// HttpTraceTCPOnlyV6Programs contains all programs after they have been loaded into the kernel.
//
// It can be passed to LoadHttpTraceTCPOnlyV6Objects or ebpf.CollectionSpec.LoadAndAssign.
type HttpTraceTCPOnlyV6Programs struct {
...
func (p *HttpTraceTCPOnlyV6Programs) Close() error {
	return _HttpTraceTCPOnlyV6Close(
		p.KprobeSockRecvmsg,
		p.KprobeSockSendmsg,
		p.KprobeTcpClose,
...
func _HttpTraceTCPOnlyV6Close(closers ...io.Closer) error {
...
//
//go:embed httptracetcponlyv6_arm64_bpfel.o
var _HttpTraceTCPOnlyV6Bytes []byte
